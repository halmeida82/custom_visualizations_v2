(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["v1_common"] = factory();
	else
		root["v1_common"] = factory();
})(window, function() {
...
function handleErrors(vis, resp, options) {
  ...
  if (resp.fields.pivots.length < options.min_pivots || resp.fields.pivots.length > options.max_pivots) {
    var message;
    vis.addError({
      group: "pivot-req",
...
window.d3v4 = __webpack_require__(12);
...
(function (t, n) {
  ...
  function Or(t) {
    ...
    t: for (a = 3; a < i; ++a) {
      ...
      for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = Dr(n); (r = r.next) !== e;) {
        (u = Dr(r)) < o && (n = r, o = u);
      }
  ...
  function ra(t) {
    ...
    for (var c = o; c.circle && Math.abs(e - c.circle.x) < x_ && Math.abs(r - c.circle.cy) < x_;) {
      o = c.P, a.unshift(c), ea(c), c = o;
    }

    a.unshift(c), ta(c);

    for (var s = u; s.circle && Math.abs(e - s.circle.x) < x_ && Math.abs(r - s.circle.cy) < x_;) {
  ...
  var ya = function ya(t, n) {
    ...
    if (a > 0) for (t = Math.ceil(t / a), n = Math.floor(n / a), u = new Array(o = Math.ceil(n - t + 1)); ++c < o;) {
      u[c] = (t + c) * a;
  ...
  var Gc,
    ...
    for (t += "", n += ""; (e = hs.exec(t)) && (r = ps.exec(n));) {
    ...
    var e,
        ...
        l = c - o,
        h = f * f + l * l;
    if (h < 1e-12) r = Math.log(s / u) / ws, e = function e(t) {
    ...
    function n(t) {
      function n(t) {
        ...
        if ("c" === v) x = y(t) + x, t = "";else {
          var b = (t = +t) < 0;
          if (t = y(Math.abs(t), d), b && 0 == +t && (b = !1), f = (b ? "(" === s ? s : "-" : "-" === s || "(" === s ? "" : s) + f, x = x + ("s" === v ? Al[8 + ml / 3] : "") + (b && "(" === s ? ")" : ""), m) for (n = -1, r = t.length; ++n < r;) {
  ...
  Cu.prototype = {
    ...
    lineEnd: function lineEnd() {
      var t = this._x,
          n = this._y,
          e = t.length;
      if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);else for (var r = Lu(t), i = Lu(n), o = 0, u = 1; u < e; ++o, ++u) {
  ...
  t.version = "4.12.0", t.bisect = ba, t.bisectRight = ba, t.bisectLeft = wa, t.ascending = ya, t.bisector = ma, t.cross = function (t, e, r) {
    ...
    function t(n, i, u, a) {
      ...
      for (var c, s, f, l = -1, h = n.length, p = o[i++], d = Kt(), v = u(); ++l < h;) {
    ...
    function p() {
      ...
      for (T_(), g && (g = clearTimeout(g)), n = 0; n < f; ++n) {
