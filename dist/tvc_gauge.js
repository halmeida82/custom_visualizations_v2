...
function buildChart(element, data, queryResponse, vis) {
    ...
    console.log(opts);
    var colorDarker = d3__WEBPACK_IMPORTED_MODULE_0__["rgb"](opts.baseColor).darker(0.5);
    var colorBrighter = d3__WEBPACK_IMPORTED_MODULE_0__["rgb"](opts.baseColor).brighter(0.5);
    var chartContainer = d3__WEBPACK_IMPORTED_MODULE_0__["select"](element);
    ...
    // Generate arc
    vis.gaugeArc = d3__WEBPACK_IMPORTED_MODULE_0__["arc"]()
    ...
    var gradientArc = d3__WEBPACK_IMPORTED_MODULE_0__["arc"]()
        .innerRadius(opts.radius.inner)
        .outerRadius(opts.radius.outer);
    // Generate data to create the slices for the gradient arc
    var datum = d3__WEBPACK_IMPORTED_MODULE_0__["range"](200).map(function (i) {
        return {
    ...
    vis.gradientGroup
        ...
        return d3__WEBPACK_IMPORTED_MODULE_0__["rgb"](red, green, blue).toString();
    });
...
function updateValue(value, animate, vis) {
    vis.clipPath
        ...
        var interpolatedValue = d3__WEBPACK_IMPORTED_MODULE_0__["interpolate"](d.endAngle, newAngle);
        return function (t) {
