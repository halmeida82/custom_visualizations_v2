  ...
  function arc() {
    ...
    // Or is it a circular or annular sector?
      ...
      if (rc > math_epsilon) {
        ...
        if (da < math_pi && (oc = arc_intersect(x01, y01, x00, y00, x11, y11, x10, y10))) {
          var ax = x01 - oc[0],
              ay = y01 - oc[1],
              bx = x11 - oc[0],
              by = y11 - oc[1],
...
// CONCATENATED MODULE: ./src/core/styles.ts
/*
...
/* harmony default export */ var d3_array_src_histogram = (function() {
  ...
  function histogram(data) {
    ...
    if (!Array.isArray(tz)) {
      ...
      tz = d3_array_src_range(Math.ceil(x0 / tz) * tz, Math.floor(x1 / tz) * tz, tz); // exclusive
    }
...
/* harmony default export */ var d3_array_src_max = (function(values, valueof) {
  var n = values.length,
      i = -1,
      value,
      max;
...
/* harmony default export */ var d3_array_src_mean = (function(values, valueof) {
  var n = values.length,
      m = n,
      i = -1,
      value,
...
/* harmony default export */ var d3_array_src_min = (function(values, valueof) {
  var n = values.length,
      i = -1,
      value,
      min;
...
/* harmony default export */ var d3_array_src_sum = (function(values, valueof) {
  var n = values.length,
      i = -1,
      value,
      sum = 0;
...
/* harmony default export */ var src_ribbon = (function() {
  ...
  function ribbon() {
    var buffer,
        argv = d3_chord_src_array_slice.call(arguments),
        s = source.apply(this, argv),
        t = target.apply(this, argv),
        sr = +radius.apply(this, (argv[0] = s, argv)),
        sa0 = startAngle.apply(this, argv) - src_math_halfPi,
        sa1 = endAngle.apply(this, argv) - src_math_halfPi,
        sx0 = sr * math_cos(sa0),
        sy0 = sr * math_sin(sa0),
        tr = +radius.apply(this, (argv[0] = t, argv)),
        ta0 = startAngle.apply(this, argv) - src_math_halfPi,
        ta1 = endAngle.apply(this, argv) - src_math_halfPi;
...
// CONCATENATED MODULE: ./node_modules/d3/node_modules/d3-collection/src/map.js
var map_prefix = "$";
...
// CONCATENATED MODULE: ./node_modules/d3/node_modules/d3-collection/src/nest.js
...
// CONCATENATED MODULE: ./node_modules/d3/node_modules/d3-collection/src/set.js
...
// CONCATENATED MODULE: ./node_modules/d3/node_modules/d3-collection/src/keys.js
...
// CONCATENATED MODULE: ./node_modules/d3/node_modules/d3-collection/src/values.js
...
// CONCATENATED MODULE: ./node_modules/d3/node_modules/d3-collection/src/entries.js
...
// CONCATENATED MODULE: ./node_modules/d3/node_modules/d3-collection/index.js
...
map_Map.prototype = src_map_map.prototype = {
  ...
  clear: function() {
    for (var property in this) if (property[0] === src_map_prefix) delete this[property];
  },
  keys: function() {
    var keys = [];
    for (var property in this) if (property[0] === src_map_prefix) keys.push(property.slice(1));
    return keys;
  },
  values: function() {
    var values = [];
    for (var property in this) if (property[0] === src_map_prefix) values.push(this[property]);
    return values;
  },
  entries: function() {
    var entries = [];
    for (var property in this) if (property[0] === src_map_prefix) entries.push({key: property.slice(1), value: this[property]});
    return entries;
  },
  size: function() {
    var size = 0;
    for (var property in this) if (property[0] === src_map_prefix) ++size;
    return size;
  },
  empty: function() {
    for (var property in this) if (property[0] === src_map_prefix) return false;
    return true;
  },
  each: function(f) {
    for (var property in this) if (property[0] === src_map_prefix) f(this[property], property.slice(1), this);
  }
};
...
/* harmony default export */ var d3_collection_src_map = (src_map_map);

// CONCATENATED MODULE: ./node_modules/d3-collection/src/nest.js


/* harmony default export */ var d3_collection_src_nest = (function() {
  var keys = [],
      sortKeys = [],
      sortValues,
      rollup,
  ...
  function apply(array, depth, createResult, setResult) {
    ...
    var i = -1,
        ...
        keyValue,
        value,
        valuesByKey = d3_collection_src_map(),
        values,
        result = createResult();
...
set_Set.prototype = src_set_set.prototype = {
  constructor: set_Set,
  has: set_proto.has,
  add: function(value) {
    value += "";
...
/* harmony default export */ var d3_collection_src_set = (src_set_set);

// CONCATENATED MODULE: ./node_modules/d3-collection/src/keys.js
/* harmony default export */ var d3_collection_src_keys = (function(map) {
  var keys = [];
  for (var key in map) keys.push(key);
  return keys;
});
...
/* harmony default export */ var d3_collection_src_values = (function(map) {
  var values = [];
  for (var key in map) values.push(map[key]);
  return values;
});
...
/* harmony default export */ var d3_collection_src_entries = (function(map) {
  var entries = [];
  for (var key in map) entries.push({key: key, value: map[key]});
  return entries;
});
...
/* harmony default export */ var src_link = (function(links) {
  ...
  function initialize() {
    ...
    var i,
        n = nodes.length,
        m = links.length,
        nodeById = d3_collection_src_map(nodes, id),
        link;
...
var d3_geo_src_math_pi = Math.PI;
var d3_geo_src_math_halfPi = d3_geo_src_math_pi / 2;
var quarterPi = d3_geo_src_math_pi / 4;
var d3_geo_src_math_tau = d3_geo_src_math_pi * 2;

var math_degrees = 180 / d3_geo_src_math_pi;
var radians = d3_geo_src_math_pi / 180;
...
function math_acos(x) {
  return x > 1 ? 0 : x < -1 ? d3_geo_src_math_pi : Math.acos(x);
}

function math_asin(x) {
  return x > 1 ? d3_geo_src_math_halfPi : x < -1 ? -d3_geo_src_math_halfPi : Math.asin(x);
}
...
var areaStream = {
  ...
  polygonEnd: function() {
    ...
    areaSum.add(areaRing < 0 ? d3_geo_src_math_tau + areaRing : areaRing);
    this.lineStart = this.lineEnd = this.point = noop_noop;
  },
  sphere: function() {
    areaSum.add(d3_geo_src_math_tau);
  }
};
...
/* harmony default export */ var src_centroid = (function(object) {
  ...
  return [math_atan2(y, x) * math_degrees, math_asin(z / math_sqrt(m)) * math_degrees];
});
...
function rotationIdentity(lambda, phi) {
  return [lambda > d3_geo_src_math_pi ? lambda - d3_geo_src_math_tau : lambda < -d3_geo_src_math_pi ? lambda + d3_geo_src_math_tau : lambda, phi];
}

rotationIdentity.invert = rotationIdentity;

function rotateRadians(deltaLambda, deltaPhi, deltaGamma) {
  return (deltaLambda %= d3_geo_src_math_tau) ? (deltaPhi || deltaGamma ? compose(rotationLambda(deltaLambda), rotationPhiGamma(deltaPhi, deltaGamma))
...
function forwardRotationLambda(deltaLambda) {
  return function(lambda, phi) {
    return lambda += deltaLambda, [lambda > d3_geo_src_math_pi ? lambda - d3_geo_src_math_tau : lambda < -d3_geo_src_math_pi ? lambda + d3_geo_src_math_tau : lambda, phi];
  };
}
...
function circleStream(stream, radius, delta, direction, t0, t1) {
  ...
  if (t0 == null) {
    t0 = radius + direction * d3_geo_src_math_tau;
    t1 = radius - step / 2;
  } else {
    t0 = circleRadius(cosRadius, t0);
    t1 = circleRadius(cosRadius, t1);
    if (direction > 0 ? t0 < t1 : t0 > t1) t0 += direction * d3_geo_src_math_tau;
  }
...
function circleRadius(cosRadius, point) {
  ...
  return ((-point[2] < 0 ? -radius : radius) + d3_geo_src_math_tau - src_math_epsilon) % d3_geo_src_math_tau;
}
...
function clip_compareIntersection(a, b) {
  return ((a = a.x)[0] < 0 ? a[1] - d3_geo_src_math_halfPi - src_math_epsilon : d3_geo_src_math_halfPi - a[1])
       - ((b = b.x)[0] < 0 ? b[1] - d3_geo_src_math_halfPi - src_math_epsilon : d3_geo_src_math_halfPi - b[1]);
}
...
/* harmony default export */ var clip_antimeridian = (src_clip(
  ...
  [-d3_geo_src_math_pi, -d3_geo_src_math_halfPi]
));
...
function clipAntimeridianLine(stream) {
  ...
  return {
    ...
    point: function(lambda1, phi1) {
      var sign1 = lambda1 > 0 ? d3_geo_src_math_pi : -d3_geo_src_math_pi,
          delta = math_abs(lambda1 - lambda0);
      if (math_abs(delta - d3_geo_src_math_pi) < src_math_epsilon) { // line crosses a pole
        stream.point(lambda0, phi0 = (phi0 + phi1) / 2 > 0 ? d3_geo_src_math_halfPi : -d3_geo_src_math_halfPi);
        ...
        clean = 0;
      } else if (sign0 !== sign1 && delta >= d3_geo_src_math_pi) { // line crosses antimeridian
...
function clipAntimeridianInterpolate(from, to, direction, stream) {
  var phi;
  if (from == null) {
    phi = direction * d3_geo_src_math_halfPi;
    stream.point(-d3_geo_src_math_pi, phi);
    stream.point(0, phi);
    stream.point(d3_geo_src_math_pi, phi);
    stream.point(d3_geo_src_math_pi, 0);
    stream.point(d3_geo_src_math_pi, -phi);
    stream.point(0, -phi);
    stream.point(-d3_geo_src_math_pi, -phi);
    stream.point(-d3_geo_src_math_pi, 0);
    ...
    var lambda = from[0] < to[0] ? d3_geo_src_math_pi : -d3_geo_src_math_pi;
...
/* harmony default export */ var clip_circle = (function(radius) {
    ...
    return {
      ...
      point: function(lambda, phi) {
        var point1 = [lambda, phi],
            ...
            c = smallRadius
              ? v ? 0 : code(lambda, phi)
              : v ? code(lambda + (lambda < 0 ? d3_geo_src_math_pi : -d3_geo_src_math_pi), phi) : 0;
  ...
  function intersect(a, b, two) {
    ...
    var delta = lambda1 - lambda0,
        polar = math_abs(delta - d3_geo_src_math_pi) < src_math_epsilon,
    ...
    if (meridian
        ? polar
          ...
          : phi0 <= q[1] && q[1] <= phi1
        : delta > d3_geo_src_math_pi ^ (lambda0 <= q[0] && q[0] <= lambda1)) {
  ...
  function code(lambda, phi) {
    var r = smallRadius ? radius : d3_geo_src_math_pi - radius,
        code = 0;
  ...
  return src_clip(visible, clipLine, interpolate, smallRadius ? [0, -radius] : [-d3_geo_src_math_pi, radius - d3_geo_src_math_pi]);
});
...
function containsLine(coordinates, point) {
  ...
  return ao + ob <= ab + src_math_epsilon;
}
...
/* harmony default export */ var src_interpolate = (function(a, b) {
  ...
  var interpolate = d ? function(t) {
    var B = src_math_sin(t *= d) / k,
        ...
        z = A * sy0 + B * sy1;
    return [
      math_atan2(y, x) * math_degrees,
      math_atan2(z, math_sqrt(x * x + y * y)) * math_degrees
    ];
  } : function() {
  ...
  point: function(x, y) {
    switch (this._point) {
      ...
      default: {
        ...
        this._context.arc(x, y, this._radius, 0, d3_geo_src_math_tau);
        break;
      }
    }
  },
...
function mercatorRaw(lambda, phi) {
  return [lambda, log(tan((d3_geo_src_math_halfPi + phi) / 2))];
}

mercatorRaw.invert = function(x, y) {
  return [x, 2 * atan(exp(y)) - d3_geo_src_math_halfPi];
};

/* harmony default export */ var mercator = (function() {
  return mercatorProjection(mercatorRaw)
      .scale(961 / d3_geo_src_math_tau);
});
...
function mercatorProjection(project) {
  ...
  function reclip() {
    var k = d3_geo_src_math_pi * scale(),
...
function tany(y) {
  return tan((d3_geo_src_math_halfPi + y) / 2);
}
...
function conicConformalRaw(y0, y1) {
  ...
  function project(x, y) {
    if (f > 0) { if (y < -d3_geo_src_math_halfPi + src_math_epsilon) y = -d3_geo_src_math_halfPi + src_math_epsilon; }
    else { if (y > d3_geo_src_math_halfPi - src_math_epsilon) y = d3_geo_src_math_halfPi - src_math_epsilon; }
  ...
  project.invert = function(x, y) {
    ...
    return [math_atan2(x, math_abs(fy)) / n * math_sign(fy), 2 * atan(pow(f / r, 1 / n)) - d3_geo_src_math_halfPi];
  };
...
function conicEquidistantRaw(y0, y1) {
  ...
  project.invert = function(x, y) {
    var gy = g - y;
    return [math_atan2(x, math_abs(gy)) / n * math_sign(gy), g - math_sign(n) * math_sqrt(x * x + gy * gy)];
  };
...
function transverseMercatorRaw(lambda, phi) {
  return [log(tan((d3_geo_src_math_halfPi + phi) / 2)), -lambda];
}

transverseMercatorRaw.invert = function(x, y) {
  return [-y, 2 * atan(exp(x)) - d3_geo_src_math_halfPi];
};
...
// CONCATENATED MODULE: ./node_modules/d3/node_modules/d3-path/src/path.js
var src_path_pi = Math.PI,
    src_path_tau = 2 * src_path_pi,
    path_epsilon = 1e-6,
    path_tauEpsilon = src_path_tau - path_epsilon;
...
// CONCATENATED MODULE: ./node_modules/d3/node_modules/d3-path/index.js
...
/* harmony default export */ var d3_polygon_src_cross = (function(a, b, c) {
...
function computeUpperHullIndexes(points) {
  ...
  for (var i = 2; i < n; ++i) {
    while (size > 1 && d3_polygon_src_cross(points[indexes[size - 2]], points[indexes[size - 1]], points[i]) <= 0) --size;
    indexes[size++] = i;
  }
...
function ordinal(range) {
  var index = d3_collection_src_map(),
      domain = [],
      unknown = implicit;
...
/* harmony default export */ var node_modules_d3_shape_src_constant = (function(x) {
  return function constant() {
    return x;
  };
});
...
var d3_shape_src_math_cos = Math.cos;
var d3_shape_src_math_max = Math.max;
var src_math_min = Math.min;
var d3_shape_src_math_sin = Math.sin;
...
function src_arc_intersect(x0, y0, x1, y1, x2, y2, x3, y3) {
  var x10 = x1 - x0, y10 = y1 - y0,
      x32 = x3 - x2, y32 = y3 - y2,
...
function arc_cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1,
      ...
      r = r1 - rc,
      D = x11 * y10 - x10 * y11,
      d = (dy < 0 ? -1 : 1) * src_math_sqrt(d3_shape_src_math_max(0, r * r * d2 - D * D)),
      cx0 = (D * dy - dx * d) / d2,
      cy0 = (-D * dx - dy * d) / d2,
      cx1 = (D * dy + dx * d) / d2,
      cy1 = (-D * dx + dy * d) / d2,
...
/* harmony default export */ var d3_shape_src_arc = (function() {
  var innerRadius = arc_arcInnerRadius,
      outerRadius = arc_arcOuterRadius,
      cornerRadius = node_modules_d3_shape_src_constant(0),
      padRadius = null,
  ...
  function arc() {
    ...
    // Or is it a circle or annulus?
    else if (da > d3_shape_src_math_tau - d3_shape_src_math_epsilon) {
      context.moveTo(r1 * d3_shape_src_math_cos(a0), r1 * d3_shape_src_math_sin(a0));
      context.arc(0, 0, r1, a0, a1, !cw);
      if (r0 > d3_shape_src_math_epsilon) {
        context.moveTo(r0 * d3_shape_src_math_cos(a1), r0 * d3_shape_src_math_sin(a1));
        context.arc(0, 0, r0, a1, a0, cw);
      }
    }
    ...
    // Or is it a circular or annular sector?
      ...
      var a01 = a0,
          ...
          da1 = da,
          ap = padAngle.apply(this, arguments) / 2,
          rp = (ap > d3_shape_src_math_epsilon) && (padRadius ? +padRadius.apply(this, arguments) : src_math_sqrt(r0 * r0 + r1 * r1)),
          rc = src_math_min(src_math_abs(r1 - r0) / 2, +cornerRadius.apply(this, arguments)),
          rc0 = rc,
          rc1 = rc,
          t0,
          t1;
      ...
      if (rp > d3_shape_src_math_epsilon) {
        var p0 = src_math_asin(rp / r0 * d3_shape_src_math_sin(ap)),
            p1 = src_math_asin(rp / r1 * d3_shape_src_math_sin(ap));
      ...
      var x01 = r1 * d3_shape_src_math_cos(a01),
          y01 = r1 * d3_shape_src_math_sin(a01),
          x10 = r0 * d3_shape_src_math_cos(a10),
          y10 = r0 * d3_shape_src_math_sin(a10);

      // Apply rounded corners?
      if (rc > d3_shape_src_math_epsilon) {
        var x11 = r1 * d3_shape_src_math_cos(a11),
            y11 = r1 * d3_shape_src_math_sin(a11),
            x00 = r0 * d3_shape_src_math_cos(a00),
            y00 = r0 * d3_shape_src_math_sin(a00);

        // Restrict the corner radius according to the sector angle.
        if (da < d3_shape_src_math_pi) {
          var oc = da0 > d3_shape_src_math_epsilon ? src_arc_intersect(x01, y01, x00, y00, x11, y11, x10, y10) : [x10, y10],
              ax = x01 - oc[0],
              ay = y01 - oc[1],
              bx = x11 - oc[0],
              by = y11 - oc[1],
              kc = 1 / d3_shape_src_math_sin(src_math_acos((ax * bx + ay * by) / (src_math_sqrt(ax * ax + ay * ay) * src_math_sqrt(bx * bx + by * by))) / 2),
      ...
      // Does the sector’s outer ring have rounded corners?
        ...
        // Have the corners merged?
        if (rc1 < rc) context.arc(t0.cx, t0.cy, rc1, src_math_atan2(t0.y01, t0.x01), src_math_atan2(t1.y01, t1.x01), !cw);

        // Otherwise, draw the two corners and the ring.
        else {
          context.arc(t0.cx, t0.cy, rc1, src_math_atan2(t0.y01, t0.x01), src_math_atan2(t0.y11, t0.x11), !cw);
          context.arc(0, 0, r1, src_math_atan2(t0.cy + t0.y11, t0.cx + t0.x11), src_math_atan2(t1.cy + t1.y11, t1.cx + t1.x11), !cw);
          context.arc(t1.cx, t1.cy, rc1, src_math_atan2(t1.y11, t1.x11), src_math_atan2(t1.y01, t1.x01), !cw);
        }
      }
      ...
      // Does the sector’s inner ring (or point) have rounded corners?
        ...
        // Have the corners merged?
        if (rc0 < rc) context.arc(t0.cx, t0.cy, rc0, src_math_atan2(t0.y01, t0.x01), src_math_atan2(t1.y01, t1.x01), !cw);

        // Otherwise, draw the two corners and the ring.
        else {
          context.arc(t0.cx, t0.cy, rc0, src_math_atan2(t0.y01, t0.x01), src_math_atan2(t0.y11, t0.x11), !cw);
          context.arc(0, 0, r0, src_math_atan2(t0.cy + t0.y11, t0.cx + t0.x11), src_math_atan2(t1.cy + t1.y11, t1.cx + t1.x11), cw);
          context.arc(t1.cx, t1.cy, rc0, src_math_atan2(t1.y11, t1.x11), src_math_atan2(t1.y01, t1.x01), !cw);
        }
      }
  ...
  arc.centroid = function() {
    ...
    return [d3_shape_src_math_cos(a) * r, d3_shape_src_math_sin(a) * r];
  };

  arc.innerRadius = function(_) {
    return arguments.length ? (innerRadius = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), arc) : innerRadius;
  };

  arc.outerRadius = function(_) {
    return arguments.length ? (outerRadius = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), arc) : outerRadius;
  };

  arc.cornerRadius = function(_) {
    return arguments.length ? (cornerRadius = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), arc) : cornerRadius;
  };

  arc.padRadius = function(_) {
    return arguments.length ? (padRadius = _ == null ? null : typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), arc) : padRadius;
  };

  arc.startAngle = function(_) {
    return arguments.length ? (startAngle = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), arc) : startAngle;
  };

  arc.endAngle = function(_) {
    return arguments.length ? (endAngle = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), arc) : endAngle;
  };

  arc.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), arc) : padAngle;
  };
...
/* harmony default export */ var src_line = (function() {
  var x = point_x,
      y = point_y,
      defined = node_modules_d3_shape_src_constant(true),
      context = null,
      curve = curve_linear,
      output = null;
  ...
  function line(data) {
    ...
    if (context == null) output = curve(buffer = d3_path_src_path());
  ...
  line.x = function(_) {
    return arguments.length ? (x = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), line) : x;
  };

  line.y = function(_) {
    return arguments.length ? (y = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), line) : y;
  };

  line.defined = function(_) {
    return arguments.length ? (defined = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(!!_), line) : defined;
  };
...
/* harmony default export */ var d3_shape_src_area = (function() {
  var x0 = point_x,
      x1 = null,
      y0 = node_modules_d3_shape_src_constant(0),
      y1 = point_y,
      defined = node_modules_d3_shape_src_constant(true),
      context = null,
      curve = curve_linear,
  ...
  area.x = function(_) {
    return arguments.length ? (x0 = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), x1 = null, area) : x0;
  };

  area.x0 = function(_) {
    return arguments.length ? (x0 = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), area) : x0;
  };

  area.x1 = function(_) {
    return arguments.length ? (x1 = _ == null ? null : typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), area) : x1;
  };

  area.y = function(_) {
    return arguments.length ? (y0 = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), y1 = null, area) : y0;
  };

  area.y0 = function(_) {
    return arguments.length ? (y0 = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), area) : y0;
  };

  area.y1 = function(_) {
    return arguments.length ? (y1 = _ == null ? null : typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), area) : y1;
  };
  ...
  area.defined = function(_) {
    return arguments.length ? (defined = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(!!_), area) : defined;
  };
...
/* harmony default export */ var d3_shape_src_descending = (function(a, b) {
  return b < a ? -1 : b > a ? 1 : b >= a ? 0 : NaN;
});
...
/* harmony default export */ var src_pie = (function() {
  var value = d3_shape_src_identity,
      sortValues = d3_shape_src_descending,
      sort = null,
      startAngle = node_modules_d3_shape_src_constant(0),
      endAngle = node_modules_d3_shape_src_constant(d3_shape_src_math_tau),
      padAngle = node_modules_d3_shape_src_constant(0);
  ...
  pie.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), pie) : value;
  };
  ...
  pie.startAngle = function(_) {
    return arguments.length ? (startAngle = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), pie) : startAngle;
  };

  pie.endAngle = function(_) {
    return arguments.length ? (endAngle = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), pie) : endAngle;
  };

  pie.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), pie) : padAngle;
  };
...
function link_link(curve) {
  ...
  link.x = function(_) {
    return arguments.length ? (x = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), link) : x;
  };

  link.y = function(_) {
    return arguments.length ? (y = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), link) : y;
  };
...
/* harmony default export */ var src_symbol = (function() {
  var type = node_modules_d3_shape_src_constant(symbol_circle),
      size = node_modules_d3_shape_src_constant(64),
      context = null;
  ...
  symbol.type = function(_) {
    return arguments.length ? (type = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(_), symbol) : type;
  };

  symbol.size = function(_) {
    return arguments.length ? (size = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), symbol) : size;
  };
...
/* harmony default export */ var src_stack = (function() {
  var keys = node_modules_d3_shape_src_constant([]),
      order = order_none,
      offset = offset_none,
      value = stackValue;
  ...
  stack.keys = function(_) {
    return arguments.length ? (keys = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(d3_shape_src_array_slice.call(_)), stack) : keys;
  };

  stack.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(+_), stack) : value;
  };

  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? order_none : typeof _ === "function" ? _ : node_modules_d3_shape_src_constant(d3_shape_src_array_slice.call(_)), stack) : order;
  };
...
// CONCATENATED MODULE: ./src/visualizations/gauge/gauge.models.ts
/*
 * Copyright (c) 2018 Sensormatic Electronics, LLC. All rights reserved.
 * Reproduction is forbidden without written approval of Sensormatic Electronics, LLC.
 */

var GAUGE_DEFAULT_OPTION_VALUES = {
    circleGap: 60,
    height: 175,
...
// CONCATENATED MODULE: ./src/visualizations/gauge/gauge.styles.ts
/*
 * Copyright (c) 2018 Sensormatic Electronics, LLC. All rights reserved.
 * Reproduction is forbidden without written approval of Sensormatic Electronics, LLC.
 */
...
function getChartAttributes(element, config) {
    var circleRad = Math.PI * 2;
    var perimeter = gauge_deg2rad(360 - config.circleGap);
    var lateralOffset = (circleRad - perimeter) / 2;
    var angles = { start: -circleRad / 2 + lateralOffset, end: circleRad / 2 - lateralOffset };
    var radius = { inner: GAUGE_DEFAULT_OPTION_VALUES.height / 2 - config.circleThickness, outer: GAUGE_DEFAULT_OPTION_VALUES.height / 2 };
    var width = element.offsetWidth;
    var height = GAUGE_DEFAULT_OPTION_VALUES.height;
    var duration = config.transitionDuration;
...
function updateChartElement(data, queryResponse, chartElement, config) {
    // Grab the first cell of the data.
    var gaugeValues = getGaugeValues(data, queryResponse);
    var chartAttributes = getChartAttributes(chartElement, config);
    var colorDarker = color_rgb(chartAttributes.baseColor).darker(0.5);
    var colorBrighter = color_rgb(chartAttributes.baseColor).brighter(0.5);
    var chartContainer = src_select(chartElement);
    ...
    var datum = src_range(200).map(function (i) {
        return {
    ...
    var gradientId = 'foreground-clip-1';
    // Create group for the gradient using the clipPath element as clipping path
    var gradientGroup = chart.append('g').attr('clip-path', "url(" + window.location + "#" + gradientId + ")");
...
function updateChartValue(value, animate, chartAttributes, gaugeArc) {
    vis.clipPath
        .transition()
        .ease(expOut)
        .duration(animate ? chartAttributes.duration : 0)
        .attrTween('d', function (d) {
        var newAngle = value2chart(value, chartAttributes.perimeter);
